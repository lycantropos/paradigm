...
unsupported_modules_callables = list(
        chain.from_iterable(map(to_callables, unsupported_modules)))


def is_callable_supported(callable_: Callable[..., Any]) -> bool:
    return callable_ not in unsupported_modules_callables
...
def is_class_supported(class_: type) -> bool:
    return (is_not_private(class_)
            and class_ not in unsupported_classes)
...
def is_method_descriptor_supported(descriptor: MethodDescriptorType) -> bool:
    return (is_not_private(descriptor)
            and descriptor not in unsupported_methods_descriptors)
...
def is_wrapper_descriptor_supported(descriptor: WrapperDescriptorType) -> bool:
    return descriptor not in unsupported_wrappers_descriptors
