...
if sys.platform == 'linux':
    ...
    _load_and_update(classes, 'encodings.cp950', ['IncrementalDecoder',
                                                  ...
                                                  'StreamReader',
                                                  'StreamWriter'])
    _load_and_update(classes, 'encodings.euc_jis_2004', ['IncrementalDecoder',
                                                         'IncrementalEncoder',
                                                         'StreamReader',
                                                         'StreamWriter'])
    _load_and_update(classes, 'encodings.euc_jisx0213', ['IncrementalDecoder',
                                                         'IncrementalEncoder',
                                                         'StreamReader',
                                                         'StreamWriter'])
    ...
    _load_and_update(classes, 'encodings.hz', ['IncrementalDecoder',
                                               ...
                                               'StreamReader',
                                               'StreamWriter'])
    _load_and_update(classes, 'encodings.iso2022_jp', ['IncrementalDecoder',
                                                       'IncrementalEncoder',
                                                       'StreamReader',
                                                       'StreamWriter'])
    _load_and_update(classes, 'encodings.iso2022_jp_1', ['IncrementalDecoder',
                                                         'IncrementalEncoder',
                                                         'StreamReader',
                                                         'StreamWriter'])
    _load_and_update(classes, 'encodings.iso2022_jp_2', ['IncrementalDecoder',
                                                         'IncrementalEncoder',
                                                         'StreamReader',
                                                         'StreamWriter'])
    _load_and_update(classes,
                     'encodings.iso2022_jp_2004', ['IncrementalDecoder',
                                                   ...
                                                   'StreamReader',
                                                   'StreamWriter'])
    _load_and_update(classes, 'encodings.iso2022_jp_3', ['IncrementalDecoder',
                                                         'IncrementalEncoder',
                                                         'StreamReader',
                                                         'StreamWriter'])
    _load_and_update(classes,
                     'encodings.iso2022_jp_ext', ['IncrementalDecoder',
                                                  ...
                                                  'StreamReader',
                                                  'StreamWriter'])
    _load_and_update(classes, 'encodings.iso2022_kr', ['IncrementalDecoder',
                                                       'IncrementalEncoder',
                                                       'StreamReader',
                                                       'StreamWriter'])
    ...
    _load_and_add(classes, 'multiprocessing.process', 'AuthenticationString')
    ...
    _load_and_update(methods_descriptors, '_io', ['_BufferedIOBase.read',
                                                  ...
                                                  '_TextIOBase.write'])
    _load_and_update(methods_descriptors, '_thread', ['LockType.acquire_lock',
    ...
    _load_and_update(methods_descriptors, 'xxsubtype', ['spamdict.getstate',
                                                        'spamdict.setstate',
                                                        'spamlist.getstate',
                                                        'spamlist.setstate'])
